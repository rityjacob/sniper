import { DEX_CONFIG, TRANSACTION_CONFIG } from './config.js';
...
class DexManager {
    ...
    async executeSwap(tokenAddress, amount) {
        try {
            ...
            // Execute the swap
            const signature = await walletManager.signAndSendTransaction(swapTransaction.swapTransaction);
            return signature;
        }
        catch (error) {
